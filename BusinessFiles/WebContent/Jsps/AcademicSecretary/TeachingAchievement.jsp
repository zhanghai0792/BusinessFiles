...
$(function(){
	...
	$('#table_teaching_achievement').datagrid({
		url:'/BusinessFiles/getTeachingAchievementlist',
		 queryParams: {
...
function CheckRecords(){
	...
	$.ajax({
		url : "/BusinessFiles/reviewTeachingAchievement",
		type : "post",
		data :{ids:param},
		success : function(data) {
			if(data.success){
...
<body class="easyui-layout">
    ...
    <div  data-options="region:'east',title:'帮助',collapsible:true,width:250">
		<%@include file="../../inc/help/AcademicSecretary/help_TeachingAchievement.inc" %>
	</div>
