...
$(function(){
	...
	$('#table_guide_student').datagrid({
		 url:'/BusinessFiles/getGuideStudentlist',
		 queryParams: {
...
function CheckRecords(){
	...
	$.ajax({
		url : "/BusinessFiles/reviewGuideStudent",
		type : "post",
		data :{ids:param},
		success : function(data) {
			if(data.success){
...
function exportRecords(){
	...
	window.open("/BusinessFiles/exportGuideStudent?"+cond);
}
</script> 
</head>
<body class="easyui-layout">
    ...
    <div  data-options="region:'east',title:'帮助',collapsible:true,width:250">
		<%@include file="../../inc/help/AcademicSecretary/help_guideStudent.inc" %>
	</div>
