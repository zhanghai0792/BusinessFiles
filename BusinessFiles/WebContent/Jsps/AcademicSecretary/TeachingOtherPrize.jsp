...
$(function(){
	...
	$('#table_teaching_otherPrize').datagrid({
		url:'/BusinessFiles/getTeachingOtherPrizelist',
		 queryParams: {
...
function CheckRecords(){
	...
	$.ajax({
		url : "/BusinessFiles/reviewTeachingOtherPrize",
		type : "post",
		data :{ids:param},
		success : function(data) {
			if(data.success){
...
function exportRecords(){
	...
	window.open("/BusinessFiles/exportTeachingOtherPrize?"+cond);
}
</script> 
</head>
<body class="easyui-layout">
    ...
    <div  data-options="region:'east',title:'帮助',collapsible:true,width:250">
		<%@include file="../../inc/help/AcademicSecretary/help_OtherPrize.inc" %>
	</div>
