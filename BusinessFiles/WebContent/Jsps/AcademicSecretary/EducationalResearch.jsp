...
$(function(){
	...
	{title:'课题名称',field:'topic',width:380},
	{title:'立项编号',field:'topicNum',width:100,align:'center',sortable:true},
	{title:'立项时间',field:'startDate',width:100,align:'center',sortable:true},
...
//查找记录
	function searchRecord(){
		$('#table_educational_research').datagrid({  
		    url:'/BusinessFiles/getEducationalResearchlist',
		    queryParams:{  
...
function CheckRecords(){
	...
	$.ajax({
		url : "/BusinessFiles/reviewEducationalResearch",
		type : "post",
		contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
		dataType : 'json',
		data :{ids:param},
...
<body class="easyui-layout">
    ...
    <div  data-options="region:'east',title:'帮助',collapsible:true,width:250">
		<%@include file="../../inc/help/AcademicSecretary/help_EducationalResearch.inc" %>
	</div>
	<div data-options="region:'center',title:'教改课题',collapsible:false,border:false" style="overflow:hidden;">
		...
		<div id="tb_EducationalResearch" style="padding:5px;height:auto">
		    <input class="easyui-combobox" style="width:100px;" id="cmb_key" data-options="onSelect:changeKey,url:'jsondata/key_EducationResearch.json',valueField:'id',textField:'text',editable:false"/>
