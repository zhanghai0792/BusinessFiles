...
$(function(){
	...
	$('#table_scientific_achievement').datagrid({
		 url:'/BusinessFiles/getScientificAchievementlist',
		 queryParams: {
...
function Search(){
	$("#table_scientific_achievement").datagrid('load',{
		DateStart:$('#date_start').datebox('getValue'),
		DateEnd:$('#date_end').datebox('getValue'),
		status:$('#cmb_status').combobox('getValue')
	});
...
function CheckRecords(){
	...
	$.ajax({
		url : "/BusinessFiles/reviewScientificAchievement",
		type : "post",
		data :{ids:param},
		success : function(data) {
			if(data.success){
...
<body class="easyui-layout">
    ...
    <div  data-options="region:'east',title:'帮助',collapsible:true,width:250">
		<%@include file="../../inc/help/AcademicSecretary/help_ScientificAchievement.inc" %>
	</div>
